...
install -D -m 0755 usr/lib/x86_64-linux-gnu/libfprint-2/tod-1/libfprint-2-tod-1-broadcom.so %{buildroot}%{_libdir}/tod/libfprint-2-tod-1-broadcom.so
install -D -m 0755 usr/lib/x86_64-linux-gnu/libfprint-2/tod-1/libfprint-2-tod-1-broadcom-cv3plus.so %{buildroot}%{_libdir}/tod/libfprint-2-tod-1-broadcom-cv3plus.so
...
%attr(755, -, -) %{_libdir}/tod/libfprint-2-tod-1-broadcom-cv3plus.so
%attr(755, -, -) %{_libdir}/tod/libfprint-2-tod-1-broadcom.so
